        ...
        <div>
            <div class="col-md-4 offset-md-4 form">
                <form action="reset-code.php" method="POST" autocomplete="off">
                    ...
                    <div id="bio">
                        Codigo OTP:
                        <input class="form-control" type="number" name="otp" placeholder="Codigo OTP" required>
                    </div>
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="check-reset-otp" value="Envie">
                    </div>
                </form>
            </div>
        </div>
